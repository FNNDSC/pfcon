...
from pfcon.compute.cromwell.models import WorkflowId, WorkflowStatus
from pfcon.compute.abstractmgr import JobInfo, JobStatus, Image, TimeStamp, JobName, ResourcesDict
...
response_running = r"""
{
  ...
  "submittedFiles": {
    ...
    "inputs": "{}",
    "workflowUrl": "",
    "labels": "{ \"org.chrisproject.pfcon.name\": \"example-jid-1234\" }\n"
  },
  "calls": {
  ...
  "labels": {
    ...
    "org.chrisproject.pfcon.name": "example-jid-1234"
  },
...
response_failed = r"""
{
  ...
  "submittedFiles": {
    ...
    "inputs": "{}",
    "workflowUrl": "",
    "labels": "{\"org.chrisproject.pfcon.name\": \"wont-work\"}"
  },
  "calls": {
    "ChRISJob.plugin_instance": [
      {
  ...
  "labels": {
    ...
    "org.chrisproject.pfcon.name": "wont-work"
  },
...
response_done = r"""
{
  ...
  "submittedFiles": {
    ...
    "inputs": "{}",
    "workflowUrl": "",
    "labels": "{\"org.chrisproject.pfcon.name\": \"done-and-dusted\"}"
  },
  "calls": {
    "ChRISJob.plugin_instance": [
      {
  ...
  "labels": {
    ...
    "org.chrisproject.pfcon.name": "done-and-dusted"
  },
...
response_notstarted = r"""
{
  "submittedFiles": {
    ...
    "inputs": "{}",
    "workflowUrl": "",
    "labels": "{\"org.chrisproject.pfcon.name\": \"vitamin-d\"}"
  },
  "calls": {},
  "outputs": {},
  ...
  "labels": {
    ...
    "org.chrisproject.pfcon.name": "vitamin-d"
  },
...
response_queued = r"""
{
  ...
  "submittedFiles": {
    ...
    "inputs": "{}",
    "workflowUrl": "",
    "labels": "{\"org.chrisproject.pfcon.name\": \"fruity-fruit\"}"
  },
  "calls": {
    "ChRISJob.plugin_instance": [
      {
  ...
  "labels": {
    "cromwell-workflow-id": "cromwell-70d639fc-d99c-4af9-9d90-519f32a3dc9d",
    "org.chrisproject.pfcon.name": "fruity-fruit"
  },
  "submission": "2022-01-24T07:23:47.397Z",
  "status": "Running",
